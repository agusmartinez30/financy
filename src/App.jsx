...
function App() {
  ...
  return (
    <>
      <main className=" w-full md:w-1/2 md:m-auto h-screen p-6  flex flex-col justify-between bg-[#fffdfd]">
        {/* <header className=" h-[15%] flex gap-3">
          <h3 className="text-xl font-semibold ">Noviembre</h3>
          <svg
